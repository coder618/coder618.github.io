...
<html lang="en">
  <head>
    <title>Ahadul Islam [coder618][Web Developer]</title>
    <!-- Required meta tags -->
    <meta charset="utf-8">
  ...
  <div class="contact-links">
    ...
    <ul >
      ...
      <li><a target="_blank" href="https://github.com/coder618"><?php echo $github_icon  ?></a></li>
      <li><a target="_blank" href="https://profiles.wordpress.org/coder618/"><?php echo $wordpress_icon  ?></a></li>
    </ul>
