<?php 
    $arr = [
        [
            'title' => 'Build Component In Minute',
            'detail' => "Build Complex Component Structure In Minute With The Help Of WordPress add_filter function",
        ],
        [
            'title' => 'Performance',
        ...
        [
            ...
            'detail' => "Develop Component more than 10X faster than Builtin Gutenberg System.",
        ],
        [
            'title' => 'Fully Loaded',
