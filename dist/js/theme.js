...
$(document).ready(function () {
  ...
  itteration = 1;
  greetings_arr = ["Bonjour", "Hola", "مرحبا", "你好", "こんにちは", "cześć", "Hello"];
  ...
  $("ul.portfolio_sort_list a").on("click", function (e) {
    e.preventDefault();
    $("ul.portfolio_sort_list a").removeClass("active"); // get the cat from link

    var cat = $(this).attr("href"); // remove active class from all the div

    $("div.each-cat-wrapper").removeClass("active"); // add active class in matched data-cat  div
